...
export const CATEGORY_LABELS = {
  [PRODUCT_CATEGORIES.GRAINS]: 'Grains',
  [PRODUCT_CATEGORIES.FRUITS]: 'Fruits',
  [PRODUCT_CATEGORIES.VEGETABLES]: 'Vegetables',
  [PRODUCT_CATEGORIES.DAIRY]: 'Dairy',
  [PRODUCT_CATEGORIES.MEAT]: 'Meat',
} as const;

export const CATEGORY_LIST = [
  { label: CATEGORY_LABELS[PRODUCT_CATEGORIES.GRAINS], value: PRODUCT_CATEGORIES.GRAINS },
  { label: CATEGORY_LABELS[PRODUCT_CATEGORIES.FRUITS], value: PRODUCT_CATEGORIES.FRUITS },
  { label: CATEGORY_LABELS[PRODUCT_CATEGORIES.VEGETABLES], value: PRODUCT_CATEGORIES.VEGETABLES },
  { label: CATEGORY_LABELS[PRODUCT_CATEGORIES.DAIRY], value: PRODUCT_CATEGORIES.DAIRY },
  { label: CATEGORY_LABELS[PRODUCT_CATEGORIES.MEAT], value: PRODUCT_CATEGORIES.MEAT },
];
...
export const UNIT_LIST = [
  PRODUCT_UNITS.PER_KG,
  PRODUCT_UNITS.PER_UNIT,
  PRODUCT_UNITS.PER_BUNCH,
];
...
export const FORM_CONFIG = {
  ...
  UNIT_DEFAULT: 0,
  CATEGORY_DEFAULT: PRODUCT_CATEGORIES.GRAINS,
